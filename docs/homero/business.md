...
- Project status: existing frontend repo
- Countries or variants: cl, co, pe
- Primary business goal: Validate the Hogar insurance sales flow
- User success state: User completes the Hogar insurance sales flow
