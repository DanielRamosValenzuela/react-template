...
const AGE_ERROR_MESSAGES = {
  OVERAGE: 'Lamentamos informarte que superas el limite de edad para contratar este seguro.',
  UNDERAGE: 'Para contratar este seguro debes ser mayor de 18 años de edad.',
} as const;

const CoLeadCaptureForm = () => {
    ...
    <form className="d-flex flex-column w-100 gap-24" onSubmit={handleSubmit}>
      <div className="d-flex flex-column">
        <InputController
          ...
          labelText="Cedula del asegurado"
          maxLength={14}
        ...
        >
          <span className="px-16 text-neutral60 line-height-1-5 letter-spacing-negative-16">
            ...
            <Link
              ...
              href={PRIVACY_POLICY_URL_BY_COUNTRY.co}
...
export default CoLeadCaptureForm;
